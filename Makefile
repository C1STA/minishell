...
SRC = main.c \
	...
	parsing/parser/manip_node_redir3.c parsing/parser/exception.c parsing/parser/final_check_expand.c parsing/parser/final_check_expand2.c parsing/parser/final_check_expand3.c parsing/parser/supp_quotes.c \
	signals/signal.c builtin/export_with_option.c builtin/export_with_option2.c builtin/ft_unset.c builtin/ft_unset2.c ft_free/ft_free.c ft_free/ft_free_2.c ft_free/ft_free_3.c error_pars.c error_pars2.c \
	...
	exe/builtin.c exe/builtin_cd.c exe/builtin_cd_utils.c exe/builtin_echo.c exe/builtin_env.c exe/builtin_exit.c exe/builtin_export.c exe/builtin_pwd.c exe/utils.c exe/utils_2.c exe/utils_3.c prompt_name.c prompt_name_utils.c print_errors.c
